...
export default function WeatherWidget(
	props: WeatherWidgetProps & JSX.IntrinsicElements["div"],
) {
	if (!props.weatherData) return null;
	const IconElement = convertWeatherCodeToIcon(
		props.weatherData.current_weather.weathercode,
	);
		...
		? (
			...
			>
				...
				<p className="text-2xl">
					{props.weatherData.current_weather.temperature.toFixed(0)}°C
				</p>
